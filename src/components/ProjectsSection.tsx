...
const projects = [
  {
    ...
    description: "A modern, responsive website for a podiatry practice in Frankfurt. Features animated UI components, seamless page transitions, 3D graphics, mobile-optimized design, and detailed treatment information with highest performance and accessibility standards. (Client Project - Actively Maintained)",
    technologies: [
      "Next.js 14",
      "React 18",
      "TypeScript",
    ...
    <section id="projects" className="relative min-h-screen py-20 px-4" data-section="projects">
      <div className="max-w-7xl mx-auto">
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-bold mb-12 text-center text-gradient leading-tight pb-2 overflow-visible"
        >
          Projects
        </motion.h2>
